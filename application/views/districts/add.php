	...
	<div class="row">
	  <div class="col s12 m12 l12">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo base_url(); ?>index.php/Districts/add">Add</a></li>
		</ol>
	  </div>
	</div>
  </div>
...
<div class="container">
     ...
     <?php 
		...
		echo form_open_multipart('Districts/create', $attributes); 
          ...
          <div class="row">
            ...
            <div class="input-field col s6">
            	<?php
				    ...
				    echo form_dropdown('division_id', $options);
			    ?>
